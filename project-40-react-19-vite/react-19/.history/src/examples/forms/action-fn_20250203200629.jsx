...
/*
  ...
  Action функция:
Обрабатывает отправку формы, передается в prop action={}
При вызове принимает аргумент fromData с данными отправленной формы
При завершении работы сбрасывает данные формы. Отпадает необходимость создавать контролируемые инпуты
*/
