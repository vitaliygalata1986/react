...
function App() {
  ...
  const [success, setSuccess] = useState(false); // возвращает state, formAction, pending

  const [] = useActionState(handleSubmit, null); // функция обработчик, начальное состояние
